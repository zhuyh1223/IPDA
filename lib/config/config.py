...
cfg.train.dataset = 'TianjinTrain'
cfg.train.epoch = 150
...
def parse_cfg(cfg, args):
    ...
    cfg.model_dir = os.path.join(cfg.model_dir, cfg.model)
    cfg.record_dir = os.path.join(cfg.record_dir, cfg.model)
